            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto w-full max-w-md pt-10">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h1 class="mt-6 text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-5 sm:mb-8">
                            <h2 class="text-title-sm sm:text-title-md font-semibold text-gray-800 dark:text-white/90">
                                Login
                            </h2>
                        </div>
                            <form method="POST" action="{{ route('signin.submit') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" required placeholder="info@gmail.com"
