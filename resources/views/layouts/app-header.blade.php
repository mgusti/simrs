    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <form method="POST" action="{{ route('signout') }}" class="inline">
                @csrf
                <button type="submit"
                    class="inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800">
                    Logout
                </button>
            </form>
        </div>
