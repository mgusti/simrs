...
<aside id="sidebar"
    ...
    x-data="{
        ...
        isActive(fullUrl) {
            ...
            // Compare URLs without trailing slashes and query strings
            const cleanCurrent = currentUrl.split('?')[0].replace(/\/$/, '');
            const cleanFull = fullUrl.split('?')[0].replace(/\/$/, '');
            return cleanCurrent === cleanFull;
        }
    }"
    :class="{
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <div class="flex items-center gap-3">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="h-12 w-auto rounded-md border border-gray-200 bg-white p-1 dark:border-gray-700 dark:bg-gray-900"
                                ...
                                <li>
                                    ...
                                    @else
                                        ...
                                        <a href="{{ route($item['route']) }}" class="menu-item group"
                                            :class="[
                                                isActive('{{ route($item['route']) }}') ? 'menu-item-active' :
                                                'menu-item-inactive',
                                            ...
                                            <!-- Icon -->
                                            <span
                                                :class="isActive('{{ route($item['route']) }}') ? 'menu-item-icon-active' :
